...
vim.opt.signcolumn = "yes"           -- Keep signcolumn on by default (second block overrides "yes:1")
vim.opt.termguicolors = true         -- Enables true color support
vim.o.cursorline = true              -- Show which line your cursor is on
vim.o.scrolloff = 10                 -- Minimal lines to keep above/below cursor (second block: 10 > 8)
vim.o.wrap = false
vim.o.winborder = "rounded"           -- Window border style (second block overrides "rounded")
...
vim.o.inccommand = "split"           -- Preview substitutions live (second block overrides "nosplit")
...
-- Commented options from first block (preserved for reference)
-- vim.cmd.colorscheme("gruber-darker")
-- opt.guicursor = "i:block"  -- Not set in second block; can be added if desired
